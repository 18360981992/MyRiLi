...
import bw.com.donyin.MainActivity;
import bw.com.donyin.R;
...
public class AppShortCutUtil {
    ...
    public static void installRawShortCut(Context context, Class<?> clazz, boolean isShowNum, String num, boolean isStroke) {
        ...
        if(isStroke){
            shortcutIntent.putExtra(Intent.EXTRA_SHORTCUT_ICON,
                    generatorNumIcon4(
                            context,
                            ((BitmapDrawable)context.getResources().getDrawable(R.drawable.jd)).getBitmap(),
                            isShowNum,
                            num));
        }else{
            shortcutIntent.putExtra(Intent.EXTRA_SHORTCUT_ICON,
     ...
     *
     */
    public static void addNumShortCut(Context context, String clazz, boolean isShowNum, String num, boolean isStroke)
    {
