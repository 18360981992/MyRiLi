...
//    private int mCircleColor = Color.parseColor("#ff0000");  // 事务的背景
    private int mCircleColor = Color.parseColor("#E2017E");//圆形背景
...
//                canvas.drawRect(startRecX, startRecY, endRecX, endRecY, mPaint);
    ...
    private void doClickAction(int x,int y){
        ...
        if(mCurrDay==daysString[row][column]){
            mCircleColor = Color.parseColor("#E2017E");  // 只要显示的是今日，就将颜色复原
        }
